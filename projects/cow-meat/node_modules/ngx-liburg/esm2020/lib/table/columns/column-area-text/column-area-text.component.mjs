...
ColumnAreaTextComponent.ɵfac = i0.ɵɵngDeclareFactory({ minVersion: "12.0.0", version: "14.2.2", ngImport: i0, type: ColumnAreaTextComponent, deps: [{ token: i1.ElixTooltipService }, { token: i0.ViewContainerRef }], target: i0.ɵɵFactoryTarget.Component });
