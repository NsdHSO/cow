...
BaseColumn.ɵfac = i0.ɵɵngDeclareFactory({ minVersion: "12.0.0", version: "14.2.2", ngImport: i0, type: BaseColumn, deps: [], target: i0.ɵɵFactoryTarget.Component });
BaseColumn.ɵcmp = i0.ɵɵngDeclareComponent({ minVersion: "14.0.0", version: "14.2.2", type: BaseColumn, selector: "app-base", inputs: { name: "name", field: "field", className: "className", iconClass: "iconClass", editRow: "editRow", footerMessage: "footerMessage" }, viewQueries: [{ propertyName: "columnDef", first: true, predicate: MatColumnDef, descendants: true }], ngImport: i0, template: '', isInline: true });
i0.ɵɵngDeclareClassMetadata({ minVersion: "12.0.0", version: "14.2.2", ngImport: i0, type: BaseColumn, decorators: [{
            type: Component,
            args: [{
                    selector: 'app-base',
                    template: '',
...
ElixTooltipService.ɵfac = i0.ɵɵngDeclareFactory({ minVersion: "12.0.0", version: "14.2.2", ngImport: i0, type: ElixTooltipService, deps: [{ token: i1.Overlay }, { token: i0.RendererFactory2 }], target: i0.ɵɵFactoryTarget.Injectable });
ElixTooltipService.ɵprov = i0.ɵɵngDeclareInjectable({ minVersion: "12.0.0", version: "14.2.2", ngImport: i0, type: ElixTooltipService, providedIn: 'root' });
i0.ɵɵngDeclareClassMetadata({ minVersion: "12.0.0", version: "14.2.2", ngImport: i0, type: ElixTooltipService, decorators: [{
            type: Injectable,
            args: [{
                    providedIn: 'root',
                }]
...
TooltipComponent.ɵfac = i0.ɵɵngDeclareFactory({ minVersion: "12.0.0", version: "14.2.2", ngImport: i0, type: TooltipComponent, deps: [], target: i0.ɵɵFactoryTarget.Component });
TooltipComponent.ɵcmp = i0.ɵɵngDeclareComponent({ minVersion: "14.0.0", version: "14.2.2", type: TooltipComponent, selector: "elix-tooltip", inputs: { width: "width" }, ngImport: i0, template: "<div>\n  <div\n    [style.width.px]=\"width\"\n    class=\"text-white border-2 elix__shared-border-color border-solid rounded-lg m-2\"\n  >\n    <div class=\"p-2.5\">\n      <div>\n        <ng-content></ng-content>\n      </div>\n    </div>\n  </div>\n</div>\n", styles: [".elix__shared-border-color{background:var(--backgroundPrimary);border:.1rem solid rgba(234,232,232,.33);box-shadow:0 3px .3rem #d1d1d126;width:100%}\n"] });
i0.ɵɵngDeclareClassMetadata({ minVersion: "12.0.0", version: "14.2.2", ngImport: i0, type: TooltipComponent, decorators: [{
            type: Component,
...
ColumnAreaTextComponent.ɵfac = i0.ɵɵngDeclareFactory({ minVersion: "12.0.0", version: "14.2.2", ngImport: i0, type: ColumnAreaTextComponent, deps: [{ token: ElixTooltipService }, { token: i0.ViewContainerRef }], target: i0.ɵɵFactoryTarget.Component });
ColumnAreaTextComponent.ɵcmp = i0.ɵɵngDeclareComponent({ minVersion: "14.0.0", version: "14.2.2", type: ColumnAreaTextComponent, selector: "elix-column-area-text", providers: [{ provide: BaseColumn, useExisting: ColumnAreaTextComponent }], viewQueries: [{ propertyName: "tooltipRef", first: true, predicate: ["tooltipRef"], descendants: true }], usesInheritance: true, ngImport: i0, template: "<ng-container [matColumnDef]=\"field\">\n  <mat-header-cell [class]=\"className\" mat-header-cell *matHeaderCellDef>{{\n    name\n  }}</mat-header-cell>\n  <mat-cell\n    [class]=\"className\"\n    mat-cell\n    *matCellDef=\"let element\"\n    (click)=\"element.model['field'] !== '' && openTooltip(reference, element)\"\n    #reference\n  >\n    <textarea\n      matInput\n      [(ngModel)]=\"element.model[field]\"\n      [disabled]=\"element.editable\"\n      [ngStyle]=\"{ color: 'black' }\"\n    ></textarea>\n\n    <ng-template #tooltipRef>\n      <elix-tooltip [width]=\"width\">{{ vars }}</elix-tooltip>\n    </ng-template>\n  </mat-cell>\n  <mat-footer-cell *matFooterCellDef>\n    {{ footerMessage }}\n  </mat-footer-cell>\n</ng-container>\n", styles: [""], dependencies: [{ kind: "directive", type: i1$1.NgStyle, selector: "[ngStyle]", inputs: ["ngStyle"] }, { kind: "directive", type: i2.DefaultValueAccessor, selector: "input:not([type=checkbox])[formControlName],textarea[formControlName],input:not([type=checkbox])[formControl],textarea[formControl],input:not([type=checkbox])[ngModel],textarea[ngModel],[ngDefaultControl]" }, { kind: "directive", type: i2.NgControlStatus, selector: "[formControlName],[ngModel],[formControl]" }, { kind: "directive", type: i2.NgModel, selector: "[ngModel]:not([formControlName]):not([formControl])", inputs: ["name", "disabled", "ngModel", "ngModelOptions"], outputs: ["ngModelChange"], exportAs: ["ngModel"] }, { kind: "directive", type: i4.MatInput, selector: "input[matInput], textarea[matInput], select[matNativeControl],      input[matNativeControl], textarea[matNativeControl]", inputs: ["disabled", "id", "placeholder", "name", "required", "type", "errorStateMatcher", "aria-describedby", "value", "readonly"], exportAs: ["matInput"] }, { kind: "directive", type: i4$1.MatHeaderCellDef, selector: "[matHeaderCellDef]" }, { kind: "directive", type: i4$1.MatColumnDef, selector: "[matColumnDef]", inputs: ["sticky", "matColumnDef"] }, { kind: "directive", type: i4$1.MatCellDef, selector: "[matCellDef]" }, { kind: "directive", type: i4$1.MatFooterCellDef, selector: "[matFooterCellDef]" }, { kind: "directive", type: i4$1.MatHeaderCell, selector: "mat-header-cell, th[mat-header-cell]" }, { kind: "directive", type: i4$1.MatCell, selector: "mat-cell, td[mat-cell]" }, { kind: "directive", type: i4$1.MatFooterCell, selector: "mat-footer-cell, td[mat-footer-cell]" }, { kind: "component", type: TooltipComponent, selector: "elix-tooltip", inputs: ["width"] }] });
i0.ɵɵngDeclareClassMetadata({ minVersion: "12.0.0", version: "14.2.2", ngImport: i0, type: ColumnAreaTextComponent, decorators: [{
            type: Component,
...
ColumnTwoCasesComponent.ɵfac = i0.ɵɵngDeclareFactory({ minVersion: "12.0.0", version: "14.2.2", ngImport: i0, type: ColumnTwoCasesComponent, deps: null, target: i0.ɵɵFactoryTarget.Component });
ColumnTwoCasesComponent.ɵcmp = i0.ɵɵngDeclareComponent({ minVersion: "14.0.0", version: "14.2.2", type: ColumnTwoCasesComponent, selector: "elix-column-two-cases", outputs: { onValueChanges: "onValueChanges" }, providers: [{ provide: BaseColumn, useExisting: ColumnTwoCasesComponent }], usesInheritance: true, ngImport: i0, template: "<ng-container [matColumnDef]=\"field\">\n  <mat-header-cell [class]=\"className\" mat-header-cell *matHeaderCellDef>\n    {{name}}\n  </mat-header-cell>\n  <mat-cell [class]=\"className\" mat-cell *matCellDef=\"let element\">\n\n      <mat-slide-toggle *ngIf=\"element.editable && editRow; else prettyText\"  [(ngModel)]=\"element.model[field]\" ></mat-slide-toggle>\n      <ng-template #prettyText>\n      {{ element.model[field] }}\n    </ng-template>\n  </mat-cell>\n</ng-container>\n", styles: [""], dependencies: [{ kind: "directive", type: i1$1.NgIf, selector: "[ngIf]", inputs: ["ngIf", "ngIfThen", "ngIfElse"] }, { kind: "directive", type: i2.NgControlStatus, selector: "[formControlName],[ngModel],[formControl]" }, { kind: "directive", type: i2.NgModel, selector: "[ngModel]:not([formControlName]):not([formControl])", inputs: ["name", "disabled", "ngModel", "ngModelOptions"], outputs: ["ngModelChange"], exportAs: ["ngModel"] }, { kind: "directive", type: i4$1.MatHeaderCellDef, selector: "[matHeaderCellDef]" }, { kind: "directive", type: i4$1.MatColumnDef, selector: "[matColumnDef]", inputs: ["sticky", "matColumnDef"] }, { kind: "directive", type: i4$1.MatCellDef, selector: "[matCellDef]" }, { kind: "directive", type: i4$1.MatHeaderCell, selector: "mat-header-cell, th[mat-header-cell]" }, { kind: "directive", type: i4$1.MatCell, selector: "mat-cell, td[mat-cell]" }, { kind: "component", type: i4$2.MatSlideToggle, selector: "mat-slide-toggle", inputs: ["disabled", "disableRipple", "color", "tabIndex"], exportAs: ["matSlideToggle"] }], encapsulation: i0.ViewEncapsulation.None });
i0.ɵɵngDeclareClassMetadata({ minVersion: "12.0.0", version: "14.2.2", ngImport: i0, type: ColumnTwoCasesComponent, decorators: [{
            type: Component,
...
i0.ɵɵngDeclareClassMetadata({ minVersion: "12.0.0", version: "14.2.2", ngImport: i0, type: TableComponent, decorators: [{
        ...
        }], ctorParameters: function () { return [{ type: i0.ChangeDetectorRef }, { type: i1$2.BreakpointObserver }]; }, propDecorators: { dataSource: [{
                type: Input
            }], extensible: [{
                type: Input
            }], extandble$: [{
...
TableMaterialModule.ɵfac = i0.ɵɵngDeclareFactory({ minVersion: "12.0.0", version: "14.2.2", ngImport: i0, type: TableMaterialModule, deps: [], target: i0.ɵɵFactoryTarget.NgModule });
TableMaterialModule.ɵmod = i0.ɵɵngDeclareNgModule({ minVersion: "14.0.0", version: "14.2.2", ngImport: i0, type: TableMaterialModule, declarations: [TableComponent,
        ColumnTextComponent,
        ...
        ColumnSelectComponent,
        ColumnTwoCasesComponent], imports: [CommonModule,
        FormsModule,
        MatButtonModule,
        MatFormFieldModule,
        MatIconModule,
        ...
        ColumnSelectComponent,
        ColumnTwoCasesComponent] });
TableMaterialModule.ɵinj = i0.ɵɵngDeclareInjector({ minVersion: "12.0.0", version: "14.2.2", ngImport: i0, type: TableMaterialModule, imports: [CommonModule,
        FormsModule,
        MatButtonModule,
        MatFormFieldModule,
        MatIconModule,
        ...
        MatSlideToggleModule,
        DragDropModule] });
i0.ɵɵngDeclareClassMetadata({ minVersion: "12.0.0", version: "14.2.2", ngImport: i0, type: TableMaterialModule, decorators: [{
            type: NgModule,
            args: [{
                    declarations: [
                        TableComponent,
